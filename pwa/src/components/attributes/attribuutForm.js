        ...
        <div className="utrecht-card-header card-header">
          <div className="utrecht-card-head-row card-head-row row">
            ...
            <div className="col-6 text-right">
              // @TODO: redirect to /entities/id
              <Link className="utrecht-link" to="/entities/">
                <button className="utrecht-button utrecht-button-sm btn-sm btn-danger mr-2"><i className="fas fa-long-arrow-alt-left mr-2"></i>Back
                </button>
              </Link>
              <button className="utrecht-button utrecht-button-sm btn-sm btn-success" type="submit"><i className="fas fa-save mr-2"></i>Save
              </button>
            </div>
          </div>
        </div>
                      ...
                      <div className="col-6">
                        <label htmlFor="defaultInput">Default</label>
                        {
                          attribute !== null && attribute.default !== null ?
                            <input className="utrecht-textbox utrecht-textbox--html-input" name="default"
                                   id="defaultInput"
                      ...
                      <div className="col-6">
                        <label htmlFor="maximumInput">Maximum</label>
                        {
                          attribute !== null && attribute.maximum !== null ?
                            <input className="utrecht-textbox utrecht-textbox--html-input" name="maximum"
                                   id="maximumInput"
                      ...
                      <div className="col-6">
                        <label htmlFor="minimumInput">Minimum</label>
                        {
                          attribute !== null && attribute.minimum !== null ?
                            <input className="utrecht-textbox utrecht-textbox--html-input" name="minimum"
                                   id="minimumInput"
                      ...
                      <div className="col-6">
                        <label htmlFor="exclusiveMaximumInput">ExclusiveMaximum</label>
                        {
                          attribute !== null && attribute.exclusiveMaximum !== null ?
                            <div className="utrecht-html">
                              <label htmlFor="true">True</label>
                              <input type="radio" id="exclusiveMaximumInput" name="exclusiveMaximum" checked
                                     value="true"/>
                              <label htmlFor="false">False</label>
                      ...
                      <div className="col-6">
                        <label htmlFor="exclusiveMinimumInput">ExclusiveMinimum</label>
                        {
                          attribute !== null && attribute.exclusiveMinimum !== null ?
                            <div className="utrecht-html">
                              <label htmlFor="true">True</label>
                              <input type="radio" id="exclusiveMinimumInput" name="exclusiveMinimum" checked
                                     value="true"/>
                              <label htmlFor="false">False</label>
                      ...
                      <div className="col-6">
                        <label htmlFor="maxDateInput">MaxDate</label>
                        {
                          attribute !== null && attribute.maxDate !== null ?
                            <input className="utrecht-textbox utrecht-textbox--html-input" name="maxDate"
                                   id="maxDateInput"
                      ...
                      <div className="col-6">
                        <label htmlFor="minDateInput">MinDate</label>
                        {
                          attribute !== null && attribute.minDate !== null ?
                            <input className="utrecht-textbox utrecht-textbox--html-input" name="minDate"
                                   id="minDateInput"
                      ...
                      <div className="col-6">
                        <label htmlFor="notInputInput">Not</label>
                        {
                          attribute !== null && attribute.not !== null ?
                            ...
                            <input className="utrecht-textbox utrecht-textbox--html-input" name="not"
                                   id="notInputInput"/>
                        }
                      </div>
                      <div className="col-6">
                        <label htmlFor="allOfInput">AllOf</label>
                        {
                          attribute !== null && attribute.allOf !== null ?
                            ...
                            <input className="utrecht-textbox utrecht-textbox--html-input" name="allOf"
                                   id="allOfInput"/>
                        }
                      </div>
                    </div>
                      ...
                      <div className="col-6">
                        <label htmlFor="oneOfInput">OneOf</label>
                        {
                          attribute !== null && attribute.oneOf !== null ?
                            ...
                            <input className="utrecht-textbox utrecht-textbox--html-input" name="oneOf"
                                   id="oneOfInput"/>
                        }
                      </div>
                      <div className="col-6">
                        <label htmlFor="anyOfInput">AnyOf</label>
                        {
                          attribute !== null && attribute.anyOf !== null ?
                            ...
                            <input className="utrecht-textbox utrecht-textbox--html-input" name="anyOf"
                                   id="anyOfInput"/>
                        }
                      </div>
                    </div>
