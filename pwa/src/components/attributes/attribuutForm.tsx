...
export default function AttributeForm({ id, entity }) {
  ...
  const saveAttribute = (event) => {
    ...
    const allOf = retrieveFormArrayAsObject(event.target, "allOf");
    const anyOf = retrieveFormArrayAsObject(event.target, "anyOf");
    const oneOf = retrieveFormArrayAsObject(event.target, "oneOf");
    const forbiddenIf = retrieveFormArrayAsObject(event.target, "forbiddenIf");
    const requiredIf = retrieveFormArrayAsObject(event.target, "requiredIf");
    const objectConfig = retrieveFormArrayAsObject(event.target, "objectConfig");
    ...
    let body = {
      ...
      defaultValue: event.target.defaultValue.value ? event.target.defaultValue.value : null,
      fileType: event.target.fileType.value ? event.target.fileType.value : null,
      ...
      inversedBy: event.target.inversedBy.value ? event.target.inversedBy.value : null,
      ...
      maxProperties: event.target.maxProperties.value ? parseInt(event.target.maxProperties.value) : null,
    };
              ...
              <div className="row">
                <div className="col-12">
                            ...
                            attributes.map((row) => (
                              <>
                                ...
                                attribute.inversedBy.id == row.id ? (
                                  <option value={"/admin/attributes/" + row.id} selected>
                                    {row.name}
                                  </option>
                                ) : (
                                  <option value={"/admin/attributes/" + row.id}>{row.name}</option>
                                )}
                              </>
                            ))}
                        </select>
                  ...
                  <Accordion id="objectConfigAccordion" title="Object Config">
                    {attribute !== null ? (
                      <MultiDimensionalArrayInput target={"objectConfig"} data={attribute.objectConfig} />
                    ) : (
                  ...
                  <Accordion id="enumAccordion" title="Enum">
                    {attribute !== null ? (
                      <MultiDimensionalArrayInput target={"enum"} data={attribute.enum} />
                    ) : (
                  ...
                  <Accordion id="requiredIfAccordion" title="Required If">
                    {attribute !== null ? (
                      <MultiDimensionalArrayInput target={"requiredIf"} data={attribute.requiredIf} />
                    ) : (
                  ...
                  <Accordion id="forbiddenIfAccordion" title="Forbidden If">
                    {attribute !== null ? (
                      <MultiDimensionalArrayInput target={"forbiddenIf"} data={attribute.forbiddenIf} />
                    ) : (
                  ...
                  <Accordion id="allOfAccordion" title="All Of">
                    {attribute !== null ? (
                      <MultiDimensionalArrayInput target={"allOf"} data={attribute.allOf} />
                    ) : (
                  ...
                  <Accordion id="anyOfAccordion" title="Any Of">
                    {attribute !== null ? (
                      <MultiDimensionalArrayInput target={"anyOf"} data={attribute.anyOf} />
                    ) : (
                  ...
                  <Accordion id="oneOfAccordion" title="One Of">
                    {attribute !== null ? (
                      <MultiDimensionalArrayInput target={"oneOf"} data={attribute.oneOf} />
                    ) : (
