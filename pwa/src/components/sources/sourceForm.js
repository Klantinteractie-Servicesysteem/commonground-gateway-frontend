...
export default function SourceForm({ id }) {
  ...
  const saveSource = event => {
    ...
    const headers = retrieveFormArrayAsObject(event.target, "headers");
                ...
                <div className="row">
                  <div className="col-6">
                    {source !== null && source.accept !== null ? (
                      <GenericInputComponent
                        name={"Accept (accept header used for this source)"}
                        target={"accept"}
                        data={source.accept}
                        type={"text"}
                        required={"true"}
