    ...
    <footer className="utrecht-page-footer">
      <Grid container spacing={{xs: 5}}>
        <Grid item xs={12} sm={4} >
          ...
          <Link to={"/sources"} className="utrecht-link">Sources</Link> <br/>
          <Link to={"/entities"} className="utrecht-link">Entities</Link> <br/>
          <Link to={"/data"} className="utrecht-link">Data objects</Link> <br/>
          <Link to={"/logs"} className="utrecht-link">Logs</Link> <br/>
        </Grid>
       {/* <Grid item xs={12} sm={4}>*/}
       {/*   <Box>*/}
